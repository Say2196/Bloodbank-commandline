...
public class Donors {
	...
	public Donors(Integer id, String firstname, String lastname, Integer age, String gender, Date dob, Integer height,
			Integer weight, String mailid, String phone, String address, String bloodgrp, String flag,
	...
	public Donors(String firstname, String lastname, Integer age, String gender, Date dob, Integer height,
			Integer weight, String mailid, String phnno, String address, String bloodgrp, String flag,
			Date lastblooddonation) {
		super();
		this.firstname = firstname;
		this.lastname = lastname;
	...
	public String getLastBlooddonation1()
	{
		SimpleDateFormat sdf1=new SimpleDateFormat("dd-MMM-yyyy");
		String LastDonationDate=sdf1.format(this.getLastblooddonation());
